...
const Footerpage: React.FC = () => {
  return (
    <div className="p-10 lg:p-24 flex flex-col justify-between gap-16 bg-gray-100">
      <div className="flex justify-evenly items-start gap-5">
        <div className="leading-[2.5rem] space-y-3 w-1/2 sm:w-auto">
          ...
          <div className="relative w-full sm:w-auto lg:w-2/3">
            <input
              type="text"
      ...
      <div className="border-t-2 border-[#adadad] flex justify-between items-center pt-4">
        <span className="text-[#adadad] text-[14px]">© 2024 Shyfy</span>
        <p className="text-[#adadad] text-[14px]">All rights reserved</p>
      </div>
    </div>
  );
};
